...
function ViewUsers() {
    ...
    return (
        <div>
            <Header />
            <PageTitle pageTitle="View Users" />
            <div className={styles.TableContainer}>
                <div class="input-group">
                    <input style={{ maxWidth: "200px", marginLeft: "1130px", border: "1px solid #082344" }} id="searchText" type="text" class="form-control" name="q" placeholder="Search Here" onChange={filterUsers} allowClear value={searchVal} />
